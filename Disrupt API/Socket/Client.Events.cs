    ...
    public partial class Client
    {
        ...
        public void RaiseEventData(Packet packet)
        {
            ...
            lock (EventCollection) EventCollection.Enqueue(() => {
                //UnityEngine.Debug.Log($"Releasing Packet id {packet.Id} | ObjectID? {System.BitConverter.ToUInt16(new[] { packet.PayLoad[4], packet.PayLoad[5] }, 0)}");
                OnIncomingMessage(packet); Recycle(packet); });
        }
